  ...
  (function(t) {
          ...
          function t(e) {
            ...
            if (
              ...
              (this.settings.onSettingsChange =
                "function" == typeof N
                  ? N
                  : function() {}), this._loadSettings(), (this._listeners = []), (this._controls = {}), this._initDirection(), this._initStyle(), this._initTheme(), this.setLayoutType(
          ...
          return (e = t), (s = [
              ...
              value: function() {
                ...
                (t =
                  ...
                  -1 !==
                    ...
                    ? r
                    : this.settings
                        .defaultLayoutType), (this.settings.layoutType = t), (this.settings.rtl =
                  "" !== e
                    ? "true" === e
                    : this.settings.defaultTextDir), (this.settings.style =
                  -1 !== this.settings.styles.indexOf(s)
                    ? s
                    : this.settings.defaultStyle), -1 ===
                  this.settings.styles.indexOf(this.settings.style) &&
                  (this.settings.style = this.settings.styles[0]), (this.settings.layoutMenu =
                  "" !== i
                    ? "true" === i
                    : this.settings
                        .defaultMenuCollapsed), (this.settings.layoutMenuFlipped =
                  "" !== o
                    ? "true" === o
                    : this.settings
                        .defaultMenuFlipped), (this.settings.showDropdownOnHover =
                  "" !== a
                    ? "true" === a
                    : this.settings
                        .defaultShowDropdownOnHover), (this.settings.layoutNavbarFixed =
                  "" !== n
                    ? "true" === n
                    : this.settings
                        .defaultNavbarFixed), (this.settings.layoutFooterFixed =
                  "" !== l
                    ? "true" === l
                    : this.settings
                        .defaultFooterFixed), (this.settings.theme = this._getThemeByName(
                  ...
                  (this.settings.style = c.contains("dark-style")
                    ? "dark"
                    : "light"), this._hasControls("layoutType") ||
                  (this.settings.layoutType = null), this._hasControls(
                  "layoutMenuFlipped"
                ) ||
                  (this.settings.layoutMenuFlipped = null), this._hasControls(
                  "showDropdownOnHover"
                ) ||
                  (this.settings.showDropdownOnHover = null), this._hasControls(
                  "layoutNavbarFixed"
                ) ||
                  (this.settings.layoutNavbarFixed = null), this._hasControls(
                  "layoutFooterFixed"
                ) ||
                  (this.settings.layoutFooterFixed = null), this._hasControls(
                  "themes"
            ...
            },
            {
              ...
              value: function() {
                ...
                i.addEventListener("click", a), this._listeners.push([
                  i,
                  "click",
                  a,
                ]);
                ...
                n.addEventListener("click", l), this._listeners.push([
                  n,
                  "click",
                  l,
                ]);
                ...
                if (this._hasControls("rtl") && rtlSupport) {
                  ...
                  c.addEventListener("change", u), this._listeners.push([
                    c,
                    "change",
                    u,
                  ]);
                ...
                if (this._hasControls("style")) {
                  ...
                  var p = function(e) {
                    t._loadingState(!0), e.target.checked
                      ? t.setStyle("dark")
                      : t.setStyle("light");
                  };
                  h.addEventListener("change", p), this._listeners.push([
                    h,
                    "change",
                    p,
                  ]);
                ...
                if (this._hasControls("themes")) {
                  ...
                  y.addEventListener("change", f), this._listeners.push([
                    y,
                    "change",
                    f,
                  ]);
                ...
                this.setLang(this.settings.lang, !0), e === document
                  ? e.body
              ...
              value: function() {
                if (this._hasControls("style")) {
                  ...
                  this._insertStylesheet(
                    ...
                    ? ["dark-style"]
                    : ["light-style"]).forEach(function(t) {
            ...
            },
            {
              ...
              value: function(t, e) {
                ...
                function a(t, e, s) {
                  var i = document.createElement("link");
                  i.setAttribute("href", t), i.setAttribute(
                    "rel",
                    "stylesheet"
                  ), i.setAttribute("type", "text/css"), (i.className =
                    e.className);
                  var o,
                    ...
                    l = setTimeout(function() {
                      clearInterval(
                        o
                      ), clearTimeout(l), e.parentNode.removeChild(i), s(!1, t);
                    }, 15e3);
            ...
            },
            {
              key: "_cleanup",
              value: function() {
                this._removeListeners(), (this._listeners = []), (this._controls = {}), this
                  ._updateInterval &&
                  (
    ...
    6: function(t, e, s) {
      ...
      function h(t, e, s, i) {
        ...
        if (t.styleSheet) t.styleSheet.cssText = d(e, o);
          ...
          var a = document.createTextNode(o),
            n = t.childNodes;
          n[e] && t.removeChild(n[e]), n.length
            ? t.insertBefore(a, n[e])
            : t.appendChild(a);
        }
      }
      function p(t, e, s) {
      ...
      function f(t, e) {
        ...
        if (e.singleton) {
          var a = y++;
          (s = m || (m = c(e))), (i = h.bind(null, s, a, !1)), (o = h.bind(
            null,
            s,
            a,
            !0
          ...
          (s = c(e)), (i = p.bind(null, s, e)), (o = function() {
            !(function(t) {
